      ...
      {open && (
        ...
        >
          <div className="flex flex-col justify-center items-center h-[100%]">
            ...
            ) : (<CameraIcon onClick={() => filePickerRef.current.click()} className="bg-red-200 p-2 rounded-full h-14 border-2 text-red-500 cursor-pointer"/>)}
            
            <input onChange={addImageTooPost} type="file" hidden ref={filePickerRef} placeholder="Please leave your caption here..." />
            <input type="text" maxLength={150} placeholder="Please enter your caption..." className="border-none outline-none m-4 text-center w-full focus:ring-0" />
